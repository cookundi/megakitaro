                ...
                <div className={getWrapperClass(2)}>
                    <div className={getInnerClass(2)}>
                        ...
                        {activeTask === 2 && taskState === 'idle' && (
                            <button onClick={() => handleTaskAction('https://x.com/megakitaro/status/XXX', false)} className="w-full cursor-pointer sm:w-auto bg-cyber-white text-cyber-black font-bold px-6 py-3 hover:bg-cyber-red hover:text-white transition-colors">
                                EXECUTE_AMPLIFY
                            </button>
                        )}
                ...
                <div className={getWrapperClass(3)}>
                    <div className={getInnerClass(3)}>
                        ...
                        {activeTask === 3 && taskState === 'idle' && (
                            <button onClick={() => handleTaskAction('https://x.com/megakitaro/status/XXX', true)} className="w-full cursor-pointer sm:w-auto bg-cyber-white text-cyber-black font-bold px-6 py-3 hover:bg-cyber-red hover:text-white transition-colors">
                                EXECUTE_COMMENT
                            </button>
                        )}
